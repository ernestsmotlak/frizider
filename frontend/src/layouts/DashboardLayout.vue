            ...
            <div class="mx-auto max-w-md">
                <div class="rounded-2xl border border-gray-200 bg-white/95 shadow-2xl ring-1 ring-black/5 p-3">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        >
                            <div class="dashboard_layout__pulse flex items-center justify-center w-14 h-14 rounded-2xl bg-white shadow-sm ring-1 ring-green-200 text-green-700 transition-transform duration-200 group-hover:scale-105">
                        ...
                        >
                            <div class="dashboard_layout__pulse dashboard_layout__pulse_delay flex items-center justify-center w-14 h-14 rounded-2xl bg-white shadow-sm ring-1 ring-green-200 text-green-700 transition-transform duration-200 group-hover:scale-105">
                                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
