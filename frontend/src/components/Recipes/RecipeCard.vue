...
<template>
    <div
        @click="handleClick"
        class="rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer overflow-hidden border border-gray-100 active:scale-[0.98] flex flex-row sm:flex-col"
    >
        <div
            class="relative w-24 h-full sm:w-full sm:aspect-[4/3] flex-shrink-0 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden self-stretch">
            <span
            ...
            <div v-else class="w-full h-full flex items-center justify-center">
                <svg class="w-10 h-10 sm:w-16 sm:h-16 text-gray-400" fill="none" stroke="currentColor"
                     viewBox="0 0 24 24">
