...
<template>
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden relative">
        <button class="absolute top-4 right-4 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-lg shadow-md hover:bg-white hover:shadow-lg transition-all duration-200">
